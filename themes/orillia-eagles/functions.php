 ...
 * Theme setup
 */
function handmade_jewelry_website_setup() {
    load_theme_textdomain( 'handmade-jewelry-website', get_template_directory() . '/languages' );
...
add_action( 'after_setup_theme', 'handmade_jewelry_website_setup' );
 ...
 */
function handmade_jewelry_website_enqueue_frontend_styles() {
    ...
    wp_enqueue_style(
        'handmade-jewelry-website-styles',
        get_template_directory_uri() . '/assets/css/styles.css',
        array( 'handmade-jewelry-website-base' ),
        $styles_version
    );
}
add_action( 'wp_enqueue_scripts', 'handmade_jewelry_website_enqueue_frontend_styles' );

/**
 * Enqueue theme scripts for frontend only
 */
function handmade_jewelry_website_enqueue_scripts() {
    ...
    if ( file_exists( $script_path ) ) {
        wp_enqueue_script(
            'handmade-jewelry-website-script',
...
add_action( 'wp_enqueue_scripts', 'handmade_jewelry_website_enqueue_scripts' );
 ...
 */
function handmade_jewelry_website_hide_front_page_title_admin() {
...
add_action( 'admin_head', 'handmade_jewelry_website_hide_front_page_title_admin' );

function handmade_jewelry_website_hide_front_page_title_iframe( $settings, $context ) {
    $front_page_id = (int) get_option( 'page_on_front' );
 ...
 */
function handmade_jewelry_website_add_js_class() {
    ...
    wp_enqueue_script( 'handmade-jewelry-website-js-class', get_template_directory_uri() . '/assets/js/js-class.js', array(), $js_class_version, false );
}
add_action( 'wp_enqueue_scripts', 'handmade_jewelry_website_add_js_class', 1 );
